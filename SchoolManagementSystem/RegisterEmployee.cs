...
namespace SchoolManagementSystem
{
    public partial class RegisterEmployee : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-8AMRJ28V;Initial Catalog=F:\SEM.4\C# PROJECTS\SCHOOLMANAGEMENTSYSTEM\SCHOOLMANAGEMENTSYSTEM\SCHOOL.MDF;Integrated Security=True");
                con.Open();
