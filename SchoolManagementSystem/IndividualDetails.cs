...
namespace SchoolManagementSystem
{
    public partial class IndividualDetails : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=F:\Sem.4\C# Projects\SchoolManagementSystem\SchoolManagementSystem\school.mdf;Integrated Security=True;User Instance=True");
